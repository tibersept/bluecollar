...
/**
 * Wrapper for the current user project.
 * @author doan
 */
public class CurrentUserProject {
	...
	/**
	 * Creates an non-existent current user project.
	 */
	public CurrentUserProject() {
		// do nothing
	}
	
	/**
	 * Creates a current user project with the given name and timestamp.
	 * @param aName the project name
	 * @param aTimestamp the project begin timestamp
	 */
	public CurrentUserProject( String aName, Long aTimestamp ) {
		name = aName;
	...
	public boolean exists() {
		return name!=null && timestamp!=null && name.length()>0;
	}
